...
<div class="entry clr" itemprop="text">
			...
			<div class="cognito" style="border: 8px solid #f2f2f2; padding: 10px 10px;">
				<form action="{{route('documents.store')}}" method="POST" enctype="multipart/form-data">
					...
					<div class="col-md-12">
						<hr>
						<h3>EMPLOYMENT HISTORY &amp; REFERENCE CHECKS</h3>
						<hr>
					</div>
					<div class="col-md-12">
						<label for="">Cv</label>
						<input type="file" name="cv" class="form-control @error('cv') has-error @enderror">
						@error('cv')
						    <span class="invalid-feedback" role="alert">
						        <strong>{{ $message }}</strong>
						    </span>
					...
					<div class="col-md-12">
						Gurantor Form
						<input type="file" name="guarantor_form"  class="form-control @error('guarantor_form') has-error @enderror">
