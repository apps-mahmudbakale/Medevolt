...
<div class="entry clr" itemprop="text">
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<p>With an increasing demand on Healthcare services the private sector is playing an important role in supporting patients in the country and beyond. Providing jobs opportunities and working with our clients in the private sector is key to our values of Going Beyond Expectations.</p>					</div>
						</div>
				</div>
						</div>
					</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<h2 class="elementor-heading-title elementor-size-default">WHAT IS GOING BEYOND EXPECTATIONS ?</h2>		</div>
				</div>
...
<img width="824" height="990" src="wp-content/uploads/row-4-col-5-2.jpg" alt="row 4 col 5 2">
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<h2 class="elementor-heading-title elementor-size-default">going Beyond Expectations to fulfil all your healthcare staffing requirements</h2>		</div>
				</div>
