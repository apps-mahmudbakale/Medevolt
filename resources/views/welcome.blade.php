...
<div id="top-bar-wrap" class="clr">
    ...
    <i aria-hidden="true" class="fab fa-linkedin"></i>          </a>
            ...
            <div class="textwidget custom-html-widget"><a href="tel:01908326400" class=" toptext" role="button">
                        ...
                        <span class="elementor-button-text">Abuja : +23408877688</span>
        </span>
                    </a></div>      </div>
                </div>
                        </div>
            ...
            <div class="textwidget custom-html-widget"><a href="tel:01908326400" class="elementor-button-link elementor-button elementor-size-sm toptext" role="button">
                        <span class="elementor-button-content-wrapper">
                        <span class="elementor-button-text">Abuja : 01908 326 400</span>
        </span>
                    </a></div>      </div>
                </div>
                        </div>
...
Abuja : 01326 567 471                   </a></div>      </div>
            ...
            <div class="elementor-column-wrap elementor-element-populated">
                ...
                <div class="elementor-widget-container">
            <div class="textwidget custom-html-widget">
                <a href="" class="toptext" role="button" style="text-align: center">Register Now</a>
            </div>      
        </div>
                </div>
                        </div>
...
<source type="image/webp" srcset="img/txmlogo2020600222.webp 600w, img/txmlogo2020600222-300x111.webp 300w" sizes="(max-width: 600px) 100vw, 600px">
<img src="img/txmlogo2020600222.png" alt="TXM Healthcare" srcset="img/txmlogo2020600222.png 600w, img/txmlogo2020600222-300x111.png 300w" sizes="(max-width: 600px) 100vw, 600px" width="600" height="222">
</picture> -->
</a>
    </div><!-- #site-logo-inner -->
...
<source type="image/webp" srcset="img/row-4-col-2-1.webp 1x">
<img src="img/row-4-col-2-1.jpg" alt="row 4 col 2 1" loading="lazy" width="824" height="990">
</picture>
                        </div>
...
<source type="image/webp" srcset="img/row-2-col-4-2.webp 1x">
<img src="img/row-2-col-4-2.jpg" alt="row 2 col 4 2" loading="lazy" width="824" height="990">
</picture>
                        </div>
...
<source type="image/webp" srcset="img/row-4-col-5-2.webp 1x">
<img src="img/row-4-col-5-2.jpg" alt="row 4 col 5 2" loading="lazy" width="824" height="990">
</picture>
                        </div>
...
<source type="image/webp" srcset="img/row-2-col-5-1.webp 1x">
<img src="img/row-2-col-5-1.jpg" alt="row 2 col 5 1" loading="lazy" width="824" height="990">
</picture>
                        </div>
...
<!-- BGRC Marker: 2021/11/18 11:57:18am -->             
<link rel="stylesheet" id="modal-css" href="css/jquery.css" media="all">
<link rel="stylesheet" id="font-awesome-5-all-css" href="css/all.css" media="all">
<link rel="stylesheet" id="premium-addons-css" href="css/premium-addons.css" media="all">
<link rel="stylesheet" id="e-animations-css" href="css/animations.css" media="all">
...
<script src="js/jquery_003.js" id="jquery-form-js"></script>
<script src="js/jquery_004.js" id="jquery-blockui-js"></script>

<script src="js/add-to-cart.js" id="wc-add-to-cart-js"></script>
<script src="js/js.js" id="js-cookie-js"></script>

<script src="js/woocommerce.js" id="woocommerce-js"></script>;
</script>
<script src="js/cart-fragments.js" id="wc-cart-fragments-js"></script>
<script src="js/734e5f942.js" id="cb70d11b8-js"></script>
<script src="js/imagesloaded.js" id="imagesloaded-js"></script>
<script src="js/isotope_002.js" id="ow-isotop-js"></script>
<script src="js/flickity.js" id="ow-flickity-js"></script>
<script src="js/sidr.js" id="ow-sidr-js"></script>
<script src="js/magnific-popup.js" id="ow-magnific-popup-js"></script>
<script src="js/theme.js" id="oceanwp-main-js"></script>
<script src="js/woo-custom-features.js" id="oceanwp-woocommerce-custom-features-js"></script>
<script src="js/wc-gateway-ppec-order-review.js" id="wc-gateway-ppec-order-review-js"></script>
<script src="js/woo-quick-view.js" id="oceanwp-woo-quick-view-js"></script>
<script src="js/underscore.js" id="underscore-js"></script>
<script src="js/wp-util.js" id="wp-util-js"></script>
<script src="js/add-to-cart-variation.js" id="wc-add-to-cart-variation-js"></script>
<script src="js/jquery.js" id="flexslider-js"></script>
<script src="js/woo-mini-cart.js" id="oceanwp-woo-mini-cart-js"></script>
<script src="js/perfect-scrollbar.js" id="ow-perfect-scrollbar-js"></script>
<script src="js/modal-window.js" id="omw-js-scripts-js"></script>
<script src="js/social.js" id="oss-social-share-script-js"></script>
<script src="js/wp-embed.js" id="wp-embed-js"></script>
<script src="js/jquery_005.js" id="modal-js"></script>
<script data-namespace="paypal_sdk" data-partner-attribution-id="WooThemes_EC" src="js/js_002" id="paypal-checkout-sdk-js" data-uid-auto="uid_gwakesmdhfvakwylnuczrbplzdthxe"></script>
<script src="js/fetch-polyfill.js" id="wc-gateway-ppec-fetch-polyfill-js"></script>
<script src="js/promise-polyfill.js" id="wc-gateway-ppec-promise-polyfill-js"></script>
<script src="js/wc-gateway-ppec-smart-payment-buttons.js" id="wc-gateway-ppec-smart-payment-buttons-js"></script>
<script src="js/jquery_006.js" id="jquery-deserialize-js"></script>
<script src="js/select2.js" id="select2-js"></script>
<script src="js/ajax-filters.js" id="wp-job-manager-ajax-filters-js"></script>
<script src="js/jquery-numerator.js" id="jquery-numerator-js"></script>
<script src="js/isotope.js" id="isotope-js-js"></script>
<script src="js/slick.js" id="pa-slick-js"></script>
<script src="js/core.js" id="jquery-ui-core-js"></script>
<script src="js/mouse.js" id="jquery-ui-mouse-js"></script>
<script src="js/draggable.js" id="jquery-ui-draggable-js"></script>

<script src="js/premium-addons.js" id="premium-addons-js"></script>
<script src="js/sortable.js" id="jquery-ui-sortable-js"></script>
<script src="js/resizable.js" id="jquery-ui-resizable-js"></script>
<script src="js/premium-addons_002.js" id="premium-pro-js"></script>
<script src="js/webpack-pro.js" id="elementor-pro-webpack-runtime-js"></script>
<script src="js/webpack.js" id="elementor-webpack-runtime-js"></script>
<script src="js/frontend-modules.js" id="elementor-frontend-modules-js"></script>
...
<script src="js/frontend_002.js" id="elementor-pro-frontend-js"></script>
<script src="jswaypoints.js" id="elementor-waypoints-js"></script>
<script src="js/swiper.js" id="swiper-js"></script>
<script src="js/share-link.js" id="share-link-js"></script>
<script src="js/dialog.js" id="elementor-dialog-js"></script>
...
<script src="js/frontend.js" id="elementor-frontend-js"></script><span id="elementor-device-mode" class="elementor-screen-only"></span>
...
<script src="js/preloaded-elements-handlers.js" id="pro-preloaded-elements-handlers-js"></script>
<svg style="display: none;" class="e-font-icon-svg-symbols"></svg>
<script src="js/preloaded-modules.js" id="preloaded-modules-js"></script>
<script src="js/jquery_007.js" id="e-sticky-js"></script>
</div>
</body>
</html>
