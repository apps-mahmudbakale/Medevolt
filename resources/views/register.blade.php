...
<img width="190" height="190" src="{{asset('img/Aisha.jpeg')}}" alt="profile photo 190 3" loading="lazy"/>
						</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-testimonial-meta-inner">
											<div class="elementor-testimonial-image">
<img width="190" height="190" src="{{asset('img/Ikilima.jpeg')}}" alt="coco" loading="lazy"/>
